...
const StyledSignInScreenContainer = styled.div`
    height: 100vh;
    width: 100vw;
...
export const StyledSignInScreenForm = styled.form`
    display: flex;
    flex-direction: column;
...
export const StyledSignInImageContainer = styled.div`
    visibility: hidden;
    width: 0;
    height: 0;
...
export const StyledSignInImg = styled.img`
    max-width: 400px;
    max-height: 400px;

`;

export default StyledSignInScreenContainer;